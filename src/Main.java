...
public class Main {
    public static void main(String[] args) {
        ...
        Booking booking1 = new Booking(guest1, room, LocalDate.of(2021,7,19), LocalDate.of(2021,7,26),TypeOfStay.WORKTRIP);
        ArrayList<Guest> guests = new ArrayList<>();
        guests.add(guest1);
        guests.add(guest2);
        Booking booking2 = new Booking(guests, room3, LocalDate.of(2021,9,1), LocalDate.of(2021,9,14),TypeOfStay.VACATION);
